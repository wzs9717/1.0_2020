...
public class OVRDebugInfo : MonoBehaviour
{
	...
	{
		strFOV = $"FOV (deg): {OVRManager.display.GetEyeRenderDesc((XRNode)0).fov.y:F3}";
	}

	private void UpdateResolutionEyeTexture()
	{
		OVRDisplay.EyeRenderDesc eyeRenderDesc = OVRManager.display.GetEyeRenderDesc((XRNode)0);
		OVRDisplay.EyeRenderDesc eyeRenderDesc2 = OVRManager.display.GetEyeRenderDesc((XRNode)1);
