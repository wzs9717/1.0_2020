...
public class OVRCameraRig : MonoBehaviour
{
	...
	private void UpdateAnchors()
	{
		...
		centerEyeAnchor.localRotation = InputTracking.GetLocalRotation((XRNode)2);
		leftEyeAnchor.localRotation = ((!monoscopic) ? InputTracking.GetLocalRotation((XRNode)0) : centerEyeAnchor.localRotation);
		rightEyeAnchor.localRotation = ((!monoscopic) ? InputTracking.GetLocalRotation((XRNode)1) : centerEyeAnchor.localRotation);
		leftHandAnchor.localRotation = OVRInput.GetLocalControllerRotation(OVRInput.Controller.LTouch);
		rightHandAnchor.localRotation = OVRInput.GetLocalControllerRotation(OVRInput.Controller.RTouch);
		trackerAnchor.localPosition = pose.position;
		centerEyeAnchor.localPosition = InputTracking.GetLocalPosition((XRNode)2);
		leftEyeAnchor.localPosition = ((!monoscopic) ? InputTracking.GetLocalPosition((XRNode)0) : centerEyeAnchor.localPosition);
		rightEyeAnchor.localPosition = ((!monoscopic) ? InputTracking.GetLocalPosition((XRNode)1) : centerEyeAnchor.localPosition);
	...
	public void EnsureGameObjectIntegrity()
	{
		...
		{
			leftEyeAnchor = ConfigureEyeAnchor(trackingSpace, (XRNode)0);
		}
		if (centerEyeAnchor == null)
		{
			centerEyeAnchor = ConfigureEyeAnchor(trackingSpace, (XRNode)2);
		}
		if (rightEyeAnchor == null)
		{
			rightEyeAnchor = ConfigureEyeAnchor(trackingSpace, (XRNode)1);
		}
	...
	private Transform ConfigureEyeAnchor(Transform root, XRNode eye)
	{
		...
		if (transform == null)
		{
			string text3 = legacyEyeAnchorName + ((object)(XRNode)(eye)).ToString();
